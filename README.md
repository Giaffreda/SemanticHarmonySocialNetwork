...
Per costruire un immagine del Semantic harmony social network bisogna scaricare l Dokerfile e, una volata spostatisi nella cartella contente il Dockerfile, eseguire il comando <pre><code>docker build --no-cache -t socialnetwork .</pre></code> dopo "-t" invece di socialnetwork si può usare qualsiasi nome generico.
